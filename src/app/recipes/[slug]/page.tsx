...
export default function RecipePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fefcf8] dark:bg-[#0f0f1a]">
      ...
      <div className="sticky bottom-0 z-40 bg-white/90 dark:bg-[#1a1a2e]/90 backdrop-blur-xl border-t border-orange-100 dark:border-gray-800 shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-2">
          <button
            onClick={() => router.push("/")}
            className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-gray-800 rounded-xl transition-all"
          >
          ...
          <div className="flex items-center gap-1">
            ...
            >
              ...
              <span className="hidden sm:inline text-gray-600 dark:text-gray-300">Save</span>
            </button>
